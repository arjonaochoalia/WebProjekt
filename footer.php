<footer class="py-3 mt-3 modern-footer text-white">
    ...
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
        ...
        <li class="nav-item"><a href="feedback.php" class="nav-link px-2 text-white">Feedback</a></li>
    </ul>

    <!-- fake socials -->
    <div class="text-center mb-3">
        <a href="https://wa.me/YOURNUMBER" target="_blank" class="btn text-dark me-2 ">
    ...
    <p class="text-center text-white">© 2025 Beautylab</p>
</footer>